...
**功能点（用户操作）**：
1. 配置服务器，并回答有哪些服务和工具能力
   - 验收标准
      - 根据配置文件连接服务器，并可以根据询问支持什么服务器以及服务器的功能
      - 询问不同服务提供的工具时，可以列出支持的服务器提供哪些功能
      - 当没有服务器时，回答没有支持的服务
      - 当服务器连接不上时，回答服务器无法连接

2. 指定 MCP 服务器回答问题
   - 验收标准
      - 可以指定 MCP 服务器，通过服务器的合适工具获取信息，回答用户问题
      - 当服务器不存在时要回答没有这样的服务器
      - 当服务器连接不上时要回答服务器无法连接
      - 当服务器对回答问题没有帮助时，回答服务器不能提供问题相关的信息
      - 在使用服务器的过程中要显示正在连接服务器      

3. 自主决定使用服务器
   - 验收标准
      - 当用户的问题适合用服务解答时，系统应该用服务来获取信息比回答问题
      - 当用户的问题不需要服务器就可以直接回答时，应该直接回答
      - 如果适合服务器工具辅助回答，但服务器为给出有效响应，则不采用
